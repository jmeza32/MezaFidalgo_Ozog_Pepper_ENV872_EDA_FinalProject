...
```{r Pinniped Monthly Time Series, message = FALSE, warning = FALSE, echo = FALSE, fig.align = "center"}
...
```{r Pinniped Monthly Time Series, message = FALSE, warning = FALSE, include = FALSE}
...
<center>
```{r Odonotcete Geospatial Exploration}
