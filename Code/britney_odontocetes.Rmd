...
just state null and residual deviances.
...
odo_f_month <- month(first(odontocete_stranding_numbers$Month))

odontocete_ts_monthly <- ts(odontocete_stranding_numbers$Total, 
                  start = c(1990, odo_f_month), 
                  frequency = 12)
...
odontocete_ts_yearly <- ts(odontocete_stranding_numbers, start = c(1990), frequency = 1)
