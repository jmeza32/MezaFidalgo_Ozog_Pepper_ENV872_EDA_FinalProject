...
mysticete_stranding_numbers_final <- left_join(Date_Range, odontocete_stranding_numbers, by = "Date" )

mysticete_stranding_numbers_final[is.na(dontocete_stranding_numbers_final)] = 0
```
...
```
Because the 2-sided p-value was 0.434, we fail to reject the null hypothesis and say that mysticetes monthly stranding data is stationary.
