...
> We  fail to reject the H0 that monthly pinniped strandings are stationary, with a p-value of 0.48. The decomposition indicates seasonality, which fits with the patterns that were seen in the exploratory analysis.
...
> We reject the H0 that yearly pinniped strandings are stationary with a p-value of 2.22e-16. 
