...
Possible overall increasing trend in pinniped strandings and possible monthly/seasonal trend.
...
Fail to reject the H0 that monthly pinniped strandings are stationary, with a p-value of 0.48, but there could be some seasonality based on this graph.
...
Reject the H0 that yearly pinniped strandings are stationary with a p-value or 2.22e-16.
